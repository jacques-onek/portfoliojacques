...
const Contact = () => {
  return (
    <footer className='flex flex-col px-2 gap-2.5 items-center mt-10'>
        ...
        <a href="mailto:" className='flex gap-x-2 place-content-center text-center'><AiFillMail className='size-5'/> <span>onekongajaque@gmail.com</span> </a>
